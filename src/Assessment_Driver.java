...
public class Assessment_Driver {
    public static void main(String[] args) {
        ...
        System.out.println("Assessment.sum(65.3,-28) = "+Assessment.sum(65.3,-28)+" should be 37.3.");
        ...
        System.out.println("Assessment.average({-3,-4,-5,-6,-7,-8}) = "+Assessment.average(arr2)+" should be 5.5.");
